...
import org.byters.ringoid.controller.data.memorycache.Countries;
import org.byters.ringoid.model.Country;
import org.byters.ringoid.view.ui.adapter.AdapterCountries;

public abstract class ViewPhoneField extends LinearLayout {
     ...
     */
    public ViewPhoneField(Context context) {
        this(context, null);
    }
     ...
     */
    public ViewPhoneField(Context context, AttributeSet attrs) {
     ...
     */
    public ViewPhoneField(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void prepareView() {
        mSpinner = findViewById(R.id.spPhone);
        ...
        final AdapterCountries adapter = new AdapterCountries(getContext(), Countries.COUNTRIES);
        ...
        mSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                mCountry = (Country) adapter.getItem(position);
            }
    ...
    public void setDefaultCountry(String countryCode) {
        for (int i = 0; i < Countries.COUNTRIES.size(); i++) {
            Country country = (Country) Countries.COUNTRIES.get(i);
            if (country.getCode().toLowerCase().contains(countryCode.toLowerCase())) {
                mCountry = country;
