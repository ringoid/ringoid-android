...
public class CCPCountryGroup {
     ...
     */
    public DataCountry getCountryForAreaCode(Context context, Language language, String areaCode) {
        ...
        return PresenterCountry.getCountryForNameCode(context, language, nameCode);
    }
}
