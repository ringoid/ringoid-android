...
public class CountryCodePicker extends RelativeLayout {
    ...
    DataCountry selectedCCPCountry;
    DataCountry defaultCCPCountry;
    ...
    List<DataCountry> customMasterCountriesList;
    //this will be "AU,IN,US"
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            if (defaultCountryNameCode != null && defaultCountryNameCode.length() != 0) {
                if (PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), defaultCountryNameCode) != null) {
                    setUsingNameCode = true;
                    setDefaultCountry(PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), defaultCountryNameCode));
                    setSelectedCountry(defaultCCPCountry);
                }
            }

            //if default country is not set using name code.
            String defaultCountryCode = a.getString(R.styleable.CountryCodePicker_ccp_defaultPhoneCode);
            if (!setUsingNameCode) {
                //if invalid country is set using xml, it will be replaced with LIB_DEFAULT_COUNTRY_CODE
                if (PresenterCountry.getCountryForPhoneCode(getContext(), getLanguageToApply(), defaultCountryCode) == null) {
                    defaultCountryCode = CODE_USA;
                }
    ...
    private DataCountry getDefaultCountry() {
        return defaultCCPCountry;
    }

    private void setDefaultCountry(DataCountry defaultCCPCountry) {
    ...
    private DataCountry getSelectedCountry() {
    ...
    void setSelectedCountry(DataCountry selectedCCPCountry) {
        ...
        if (selectedCCPCountry == null) {
            selectedCCPCountry = PresenterCountry.getCountryForPhoneCode(getContext(), getLanguageToApply(), defaultCountryCode);
        }
        ...
        if (showFullName) {
            displayText = displayText + PresenterCountry.getName(getContext(), getLanguageToApply(), selectedCCPCountry);
        }
        ...
        imageViewFlag.setImageResource(PresenterCountry.getFlagResID(selectedCCPCountry));
            ...
            if (areaCodeCountryDetectorTextWatcher == null) {
                areaCodeCountryDetectorTextWatcher = new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        DataCountry selectedCountry = getSelectedCountry();
    ...
    private void setCustomDefaultLanguage(Language customDefaultLanguage) {
        ...
        updateLanguageToApply();
        setSelectedCountry(PresenterCountry.getCountryForNameCode(context, getLanguageToApply(), selectedCCPCountry.getNameCode()));
    }
    ...
    void refreshCustomMasterList() {
        ...
        if (customMasterCountriesParam == null || customMasterCountriesParam.length() == 0) {
            ...
            if (excludedCountriesParam != null && excludedCountriesParam.length() != 0) {
                ...
                List<DataCountry> libraryMasterList = PresenterCountry.getData(context, getLanguageToApply()).getData();
                List<DataCountry> localCCPCountryList = new ArrayList<>();
                for (DataCountry ccpCountry : libraryMasterList) {
            ...
            for (String nameCode : customMasterCountriesParam.split(",")) {
                DataCountry ccpCountry = PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), nameCode);
                if (ccpCountry != null) {
    ...
    List<DataCountry> getCustomMasterCountriesList() {
     ...
     */
    void setCustomMasterCountriesList(List<DataCountry> customMasterCountriesList) {
     ...
     */
    private boolean isAlreadyInList(DataCountry CCPCountry, List<DataCountry> CCPCountryList) {
        if (CCPCountry != null && CCPCountryList != null) {
            for (DataCountry iterationCCPCountry : CCPCountryList) {
     ...
     */
    private String detectCarrierNumber(String fullNumber, DataCountry CCPCountry) {
    ...
    String getDialogTitle() {
        return PresenterCountry.getDialogTitle(context, getLanguageToApply());
    }

    String getSearchHintText() {
        return PresenterCountry.getDialogHint(context, getLanguageToApply());
    }
    ...
    String getNoResultFoundText() {
        return PresenterCountry.getDialogNoResult(context, getLanguageToApply());
    }
     ...
     */
    @Deprecated
    public void setDefaultCountryUsingPhoneCode(String defaultCountryCode) {
        DataCountry defaultCCPCountry = PresenterCountry.getCountryForPhoneCode(getContext(), getLanguageToApply(), defaultCountryCode); //xml stores data in string format, but want to allow only numeric value to country code to user.
    ...
    public void setDefaultCountryUsingNameCode(String defaultCountryNameCode) {
        DataCountry defaultCCPCountry = PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), defaultCountryNameCode); //xml stores data in string format, but want to allow only numeric value to country code to user.
        if (defaultCCPCountry == null) { //if no correct country is found
    ...
    public String getDefaultCountryName() {
        return PresenterCountry.getName(getContext(), getLanguageToApply(), getDefaultCountry());
    }
    ...
    public void resetToDefaultCountry() {
        defaultCCPCountry = PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), getDefaultCountryNameCode());
        setSelectedCountry(defaultCCPCountry);
    }
    ...
    public String getSelectedCountryName() {
        return PresenterCountry.getName(getContext(), getLanguageToApply(), getSelectedCountry());
    }
     ...
     */
    public void setCountryForPhoneCode(String countryCode) {
        DataCountry ccpCountry = PresenterCountry.getCountryForPhoneCode(getContext(), getLanguageToApply(), countryCode); //xml stores data in string format, but want to allow only numeric value to country code to user.
        if (ccpCountry == null) {
            if (defaultCCPCountry == null) {
                defaultCCPCountry = PresenterCountry.getCountryForPhoneCode(getContext(), getLanguageToApply(), defaultCountryCode);
            }
            setSelectedCountry(defaultCCPCountry);
        } else {
    ...
    public void setCountryForNameCode(String countryNameCode) {
        DataCountry country = PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), countryNameCode); //xml stores data in string format, but want to allow only numeric value to country code to user.
        if (country == null) {
            if (defaultCCPCountry == null) {
                defaultCCPCountry = PresenterCountry.getCountryForPhoneCode(getContext(), getLanguageToApply(), defaultCountryCode);
            }
    ...
    public void setFullNumber(String fullNumber) {
        DataCountry country = PresenterCountry.getCountryForNumber(getContext(), getLanguageToApply(), fullNumber);
        if (country == null)
    ...
    public boolean detectSIMCountry(boolean loadDefaultWhenFails) {
        try {
            ...
            setSelectedCountry(PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), simCountryISO));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            if (loadDefaultWhenFails) {
    ...
    public boolean detectNetworkCountry(boolean loadDefaultWhenFails) {
        try {
            ...
            setSelectedCountry(PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), networkCountryISO));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            if (loadDefaultWhenFails) {
    ...
    public boolean detectLocaleCountry(boolean loadDefaultWhenFails) {
        try {
            ...
            setSelectedCountry(PresenterCountry.getCountryForNameCode(getContext(), getLanguageToApply(), localeCountryISO));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            if (loadDefaultWhenFails) {
    ...
    protected void onUserTappedCountry(DataCountry CCPCountry) {
